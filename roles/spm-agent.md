...
<!-- BEGIN GENERATED: doctrine spm (source: doctrine/spm.md — do not hand-edit) -->
...
- **Promotion path:** Empirical anchor required before v0.1 (per the distillation methodology §12).
