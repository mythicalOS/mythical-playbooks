...
| `docs/protocols/*.md` | Shared cross-role operational contracts such as routing, authority rhythms, artifact shapes, and validation expectations. | Role-specific permission expansion. |
...
- Encoding a filename or header contract only in prose when a script can check
  it.
